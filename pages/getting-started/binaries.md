...
> **Note:** Prebuilt releases are published infrequently. For access to the latest features and fixes, [build from source](../docs/build/building-ez.md) using the `dev` branch.

## See Also

* [Getting Started](start.md)
* [Building ezEngine](../docs/build/building-ez.md)
